...
const PostCard = ({post}) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-4 pb-12 mb-8'>
      <h1 className='transition duration-700 text-center mb-4 cursor-pointer hover:text-indigo-700 text-3xl font-semibold'>
      ...
      <div className='relative overflow-hidden shadow-md pb-80 mb-6'>
        <img 
          ...
          alt={post.title}
          className='object-center absolute h-80 w-full  shadow-lg rounded-t-lg lg:rounded-lg'
        />
      </div>
